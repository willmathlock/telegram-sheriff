...
def milagre(bot, update):
    ...
    mandaImg(bot, update, 'milagre')

def tururu(bot, update):
    tocaAudio(bot, update, 'tururu')
    mandaImg(bot, update, 'naruto')
...
def saizica(bot, update):
    tocaAudio(bot, update, 'zica')
    mandaGif(bot, update, 'titus')
...
def main():
    ...
    dispatcher.add_handler(
        CommandHandler('saizica', saizica)
    )
    dispatcher.add_handler(
